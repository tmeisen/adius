...
public class FactMutex implements Mutex<Fact> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see javaff.learning.graph.Mutex#addMutexProposition(javaff.data.strips.
	 * Proposition)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * javaff.learning.graph.Mutex#removeMutexProposition(javaff.data.strips
	 * .Proposition)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * javaff.learning.graph.Mutex#isMutexWith(javaff.data.strips.Proposition)
	 */
	@Override
