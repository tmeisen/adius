...
/**
 * Constants show properties of both a PDDLObject and Variable, but are still
 * their own type. This class inherits from Parameter just as PDDLObject and
 * Variable do, and also holds a copy of both these representations.
 * 
...
public class Constant extends PDDLObject {
	...
	@Override
	public Object clone() {
		return new Constant(this.name, this.type);
	}
}
